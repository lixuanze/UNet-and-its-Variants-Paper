...
class Residual_Attention_UNet_plus_plus:
  """
  Class for Deep Learning Hyperspectral Segmentation similar to the 2022 Residual Attention UNet++ by Li et.al - Residual-Attention UNet++: A Nested Residual-Attention U-Net for Medical Image Segmentation.
