...
class R2AUNet:
  ...
  def train(self):
    ...
    if self.utils.continue_training == True:
        ...
        r2unet = load_model('models/r2aunet_best_model.h5', custom_objects=custom_objects)
        r2unet.summary()
  ...
  def predict(self, new_data = None):
    ...
    '''
    r2unet = self.build_3d_r2aunet()
    r2unet.load_weights('models/r2aunet_best_model.h5')
