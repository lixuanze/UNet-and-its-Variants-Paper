...
from tensorflow.keras.layers import Input, Conv3D, Reshape, concatenate, Conv2D, MaxPooling3D, UpSampling3D, BatchNormalization, Add, Activation, Dropout, Flatten, Layer, Multiply
...
class R2AUNet:
  """
  Class for Deep Learning Hyperspectral Segmentation similar to the https://www.hindawi.com/journals/scn/2021/6625688/.
  ...
  def train(self):
    ...
    if self.utils.continue_training == True:
        ...
        r2unet = load_model('saved_models/r2aunet_best_model.h5', custom_objects=custom_objects)
        r2unet.summary()
  ...
  def predict(self, new_data = None):
    ...
    '''
    r2unet = self.build_3d_r2aunet()
    r2unet.load_weights('saved_models/r2aunet_best_model.h5')
