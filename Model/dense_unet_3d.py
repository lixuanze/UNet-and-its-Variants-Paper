...
class Dense_UNet:
  """
  Class for Deep Learning Hyperspectral Segmentation with a 3D Dense U-Net (Cai 2020).
  ...
  def encoding_layers_building_blocks(self, units, in_layer, pooling_layer=True):
      ...
      '''
      convolution_layer_1 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer)
      convolution_layer_1 = BatchNormalization()(convolution_layer_1)
      convolution_layer_1 = Activation('relu')(convolution_layer_1)
      
      in_layer_2 = concatenate([convolution_layer_1, in_layer], axis = -1)
      convolution_layer_2 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer_2)
      convolution_layer_2 = BatchNormalization()(convolution_layer_2)
      convolution_layer_2 = Activation('relu')(convolution_layer_2)
      
      in_layer_3 = concatenate([convolution_layer_2, convolution_layer_1, in_layer], axis = -1)
      convolution_layer_3 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer_3)
      convolution_layer_3 = BatchNormalization()(convolution_layer_3)
      convolution_layer_3 = Activation('relu')(convolution_layer_3)
      
      in_layer_4 = concatenate([convolution_layer_3, convolution_layer_2, convolution_layer_1, in_layer], axis = -1)
      convolution_layer_4 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer_4)
      ...
      if pooling_layer == True:
          out_layer = MaxPooling3D(pool_size=(2, 2, 2), padding='same')(convolution_layer_4)
  ...
  def decoding_layers_building_blocks(self, units, in_layer, concat_layer):
      ...
      convolution_layer_1 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(upsampling_layer)
      convolution_layer_1 = BatchNormalization()(convolution_layer_1)
      convolution_layer_1 = Activation('relu')(convolution_layer_1)
      
      in_layer_2 = concatenate([convolution_layer_1, upsampling_layer], axis = -1)
      convolution_layer_2 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer_2)
      convolution_layer_2 = BatchNormalization()(convolution_layer_2)
      convolution_layer_2 = Activation('relu')(convolution_layer_2)
      
      in_layer_3 = concatenate([convolution_layer_2, convolution_layer_1, upsampling_layer], axis = -1)
      convolution_layer_3 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer_3)
      convolution_layer_3 = BatchNormalization()(convolution_layer_3)
      convolution_layer_3 = Activation('relu')(convolution_layer_3)
      
      in_layer_4 = concatenate([convolution_layer_3, convolution_layer_2, convolution_layer_1, upsampling_layer], axis = -1)
      convolution_layer_4 = Conv3D(units, (3, 3, 3), padding='same', kernel_initializer='he_normal')(in_layer_4)
      convolution_layer_4 = BatchNormalization()(convolution_layer_4)
      out_layer = Activation('relu')(convolution_layer_4)
      return out_layer
  ...
  def build_3d_dense_unet(self):
    '''
    This function is a tensorflow realization of the 3D-Dense UNet Model (2020). 
    '''
  ...
  def train(self):
    ...
    if self.utils.continue_training == True:
        ...
        dense_unet = load_model('models/dense_unet_best_model.h5', custom_objects=custom_objects)
        dense_unet.summary()
        if self.utils.override_trained_optimizer:
            learning_rate_scheduler = tf.keras.optimizers.schedules.ExponentialDecay(initial_learning_rate=1e-3, decay_steps=20000, decay_rate=0.99)
            dense_unet.compile(optimizer = tf.keras.optimizers.Adam(learning_rate = learning_rate_scheduler), loss={'output_layer': self.dice_loss}, metrics=[tf.keras.metrics.MeanIoU(num_classes = self.utils.n_features)])
    else:
  ...
  def predict(self, new_data = None):
    ...
    '''
    dense_unet = self.build_3d_dense_unet()
    dense_unet.load_weights('models/dense_unet_best_model.h5')
    if new_data is not None:
      ...
      prediction_result = dense_unet.predict(X_test)
      ...
      for i in range(0, total_test_length, self.utils.batch_size):
        ...
        prediction_result[i:i+self.utils.batch_size] = dense_unet.predict(self.utils.X_test[i:i+self.utils.batch_size])
