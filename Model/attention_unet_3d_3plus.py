...
class Attention_UNet3Plus:
  ...
  def train(self):
    ...
    if self.utils.continue_training == True:
        ...
        attetion_unet = load_model('models/attention_unet_3plus_best_model.h5', custom_objects=custom_objects)
  ...
  def predict(self, new_data = None):
    ...
    '''
    attetion_unet = self.build_3d_attention_unet_3plus()
    attetion_unet.load_weights('models/attention_unet_3plus_best_model.h5')
